  ...
  return (
    <div
      className={cn(
        ...
        'prose-code:font-mono prose-code:text-neon-cyan prose-code:bg-muted/50 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm',
        'prose-pre:font-mono prose-pre:bg-terminal-black prose-pre:border prose-pre:border-border/30 prose-pre:rounded-lg',
